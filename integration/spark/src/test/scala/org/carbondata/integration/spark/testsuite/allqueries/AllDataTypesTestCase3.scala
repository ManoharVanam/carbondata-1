...
class AllDataTypesTestCase3 extends QueryTest with BeforeAndAfterAll {
  ...
  //TC_222
  test("select imei, Latest_DAY from Carbon_automation_test3 where Latest_DAY  LIKE Latest_areaId AND  Latest_DAY  LIKE Latest_HOUR") ({
    checkAnswer(
      sql("select imei, Latest_DAY from Carbon_automation_test3 where Latest_DAY  LIKE Latest_areaId AND  Latest_DAY  LIKE Latest_HOUR"),
      Seq())
  })

  //TC_224
  test("select * from (select if( Latest_areaId=7,7,NULL) as babu,Latest_MONTH from Carbon_automation_test3) qq where babu NOT LIKE   Latest_MONTH") ({
    checkAnswer(
      sql("select * from (select if( Latest_areaId=7,7,NULL) as babu,Latest_MONTH from Carbon_automation_test3) qq where babu NOT LIKE   Latest_MONTH"),
      Seq())
  })

  //TC_262
  test("select count(imei) ,series from Carbon_automation_test3 group by series having sum (Latest_DAY) == 99") ({
    checkAnswer(
      sql("select count(imei) ,series from Carbon_automation_test3 group by series having sum (Latest_DAY) == 99"),
      Seq())
  })

  //TC_264
  test("SELECT AMSize, ActiveAreaId, SUM(gamePointId) AS Sum_gamePointId FROM (select * from Carbon_automation_test3) SUB_QRY WHERE AMSize = \"\" GROUP BY AMSize, ActiveAreaId ORDER BY AMSize ASC, ActiveAreaId ASC") ({
    checkAnswer(
      sql("SELECT AMSize, ActiveAreaId, SUM(gamePointId) AS Sum_gamePointId FROM (select * from Carbon_automation_test3) SUB_QRY WHERE AMSize = \"\" GROUP BY AMSize, ActiveAreaId ORDER BY AMSize ASC, ActiveAreaId ASC"),
      Seq())
  })

  //TC_270
  test("SELECT AMSize, ActiveAreaId, SUM(gamePointId) AS Sum_gamePointId FROM (select * from Carbon_automation_test3) SUB_QRY WHERE AMSize < \"0RAM size\" GROUP BY AMSize, ActiveAreaId ORDER BY AMSize ASC, ActiveAreaId ASC") ({
    checkAnswer(
      sql("SELECT AMSize, ActiveAreaId, SUM(gamePointId) AS Sum_gamePointId FROM (select * from Carbon_automation_test3) SUB_QRY WHERE AMSize < \"0RAM size\" GROUP BY AMSize, ActiveAreaId ORDER BY AMSize ASC, ActiveAreaId ASC"),
      Seq())
  })

  //TC_320
  test("SELECT ActiveCountry, ActiveDistrict, Activecity, SUM(gamePointId) AS Sum_gamePointId FROM (select * from Carbon_automation_test3) SUB_QRY WHERE gamePointId > 1.0E9 GROUP BY ActiveCountry, ActiveDistrict, Activecity ORDER BY ActiveCountry ASC, ActiveDistrict ASC, Activecity ASC") ({
    checkAnswer(
      sql("SELECT ActiveCountry, ActiveDistrict, Activecity, SUM(gamePointId) AS Sum_gamePointId FROM (select * from Carbon_automation_test3) SUB_QRY WHERE gamePointId > 1.0E9 GROUP BY ActiveCountry, ActiveDistrict, Activecity ORDER BY ActiveCountry ASC, ActiveDistrict ASC, Activecity ASC"),
      Seq())
  })

  //TC_343
  test("SELECT latest_year, latest_day, imei, gamepointid, deviceinformationid, series, imei, deliverycity FROM (select * from Carbon_automation_test3) SUB_QRY WHERE deliverycity IS NULL") ({
    checkAnswer(
      sql("SELECT latest_year, latest_day, imei, gamepointid, deviceinformationid, series, imei, deliverycity FROM (select * from Carbon_automation_test3) SUB_QRY WHERE deliverycity IS NULL"),
      Seq())
  })
  ...
  //TC_416
  test("select  deviceinformationid from Carbon_automation_test3 where  deviceinformationid is  null") ({
    checkAnswer(
      sql("select  deviceinformationid from Carbon_automation_test3 where  deviceinformationid is  null"),
      Seq())
  })
  ...
  //TC_112
  test("select percentile(deviceInformationId,array(0,0.2,0.3,1))  as  a from Carbon_automation_test31") ({
    validateResult(
      sql("select percentile(deviceInformationId,array(0,0.2,0.3,1))  as  a from Carbon_automation_test3"),
      "TC_112.csv")
  })

  //TC_115
  test("select percentile_approx(deviceInformationId,array(0.2,0.3,0.99))  as a from Carbon_automation_test3") ({
    validateResult(
      sql("select percentile_approx(deviceInformationId,array(0.2,0.3,0.99))  as a from Carbon_automation_test3"),
      "TC_115.csv")
  })

  //TC_116
  test("select percentile_approx(deviceInformationId,array(0.2,0.3,0.99),5) as a from Carbon_automation_test3") ({
    validateResult(
      sql("select percentile_approx(deviceInformationId,array(0.2,0.3,0.99),5) as a from Carbon_automation_test3"),
      "TC_116.csv")
  })
  ...
  //TC_128
  test("select percentile(deviceInformationId,array(0,0.2,0.3,1))  as  a from Carbon_automation_test3") ({
    validateResult(
      sql("select percentile(deviceInformationId,array(0,0.2,0.3,1))  as  a from Carbon_automation_test3"),
      "TC_128.csv")
  })
  ...
  //TC_131
  test("select percentile_approx(gamePointId,array(0.2,0.3,0.99))  as a from Carbon_automation_test3") ({
    validateResult(
      sql("select percentile_approx(gamePointId,array(0.2,0.3,0.99))  as a from Carbon_automation_test3"),
      "TC_131.csv")
  })

  //TC_132
  test("select percentile_approx(gamePointId,array(0.2,0.3,0.99),5) as a from Carbon_automation_test3") ({
    validateResult(
      sql("select percentile_approx(gamePointId,array(0.2,0.3,0.99),5) as a from Carbon_automation_test3"),
      "TC_132.csv")
  })
  ...
  //TC_513
  test("SELECT Carbon_automation_test3.gamePointId AS gamePointId,Carbon_automation_test3.AMSize AS AMSize, Carbon_automation_test3.ActiveCountry AS ActiveCountry, Carbon_automation_test3.Activecity AS Activecity FROM ( SELECT AMSize,gamePointId, ActiveCountry, Activecity FROM (select * from Carbon_automation_test3) SUB_QRY ) Carbon_automation_test3 INNER JOIN ( SELECT ActiveCountry, Activecity, AMSize FROM (select * from Carbon_automation_test3) SUB_QRY ) Carbon_automation_test31 ON Carbon_automation_test3.AMSize = Carbon_automation_test31.AMSize WHERE Carbon_automation_test3.AMSize IS NULL GROUP BY Carbon_automation_test3.AMSize, Carbon_automation_test3.ActiveCountry, Carbon_automation_test3.Activecity ,Carbon_automation_test3.gamePointId ORDER BY Carbon_automation_test3.AMSize ASC, Carbon_automation_test3.ActiveCountry ASC, Carbon_automation_test3.Activecity ASC") ({
    checkAnswer(
      sql("SELECT Carbon_automation_test3.gamePointId AS gamePointId,Carbon_automation_test3.AMSize AS AMSize, Carbon_automation_test3.ActiveCountry AS ActiveCountry, Carbon_automation_test3.Activecity AS Activecity FROM ( SELECT AMSize,gamePointId, ActiveCountry, Activecity FROM (select * from Carbon_automation_test3) SUB_QRY ) Carbon_automation_test3 INNER JOIN ( SELECT ActiveCountry, Activecity, AMSize FROM (select * from Carbon_automation_test3) SUB_QRY ) Carbon_automation_test31 ON Carbon_automation_test3.AMSize = Carbon_automation_test31.AMSize WHERE Carbon_automation_test3.AMSize IS NULL GROUP BY Carbon_automation_test3.AMSize, Carbon_automation_test3.ActiveCountry, Carbon_automation_test3.Activecity ,Carbon_automation_test3.gamePointId ORDER BY Carbon_automation_test3.AMSize ASC, Carbon_automation_test3.ActiveCountry ASC, Carbon_automation_test3.Activecity ASC"),
      Seq())
  })
  ...
  test("SELECT Carbon_automation_test3.gamePointId AS gamePointId,Carbon_automation_test3.AMSize AS AMSize, Carbon_automation_test3.ActiveCountry AS ActiveCountry, Carbon_automation_test3.Activecity AS Activecity FROM ( SELECT AMSize,gamePointId, ActiveCountry, Activecity FROM (select * from Carbon_automation_test3) SUB_QRY ) Carbon_automation_test3 RIGHT JOIN ( SELECT ActiveCountry, Activecity, AMSize FROM (select * from Carbon_automation_test3) SUB_QRY ) Carbon_automation_test31 ON Carbon_automation_test3.AMSize = Carbon_automation_test31.AMSize WHERE Carbon_automation_test3.AMSize IN (\"4RAM size\",\"8RAM size\") GROUP BY Carbon_automation_test3.AMSize, Carbon_automation_test3.ActiveCountry, Carbon_automation_test3.Activecity ,Carbon_automation_test3.gamePointId ORDER BY Carbon_automation_test3.AMSize ASC, Carbon_automation_test3.ActiveCountry ASC, Carbon_automation_test3.Activecity ASC") ({
    validateResult(sql("SELECT Carbon_automation_test3.gamePointId AS gamePointId,Carbon_automation_test3.AMSize AS AMSize, Carbon_automation_test3.ActiveCountry AS ActiveCountry, Carbon_automation_test3.Activecity AS Activecity FROM ( SELECT AMSize,gamePointId, ActiveCountry, Activecity FROM (select * from Carbon_automation_test3) SUB_QRY ) Carbon_automation_test3 RIGHT JOIN ( SELECT ActiveCountry, Activecity, AMSize FROM (select * from Carbon_automation_test3) SUB_QRY ) Carbon_automation_test31 ON Carbon_automation_test3.AMSize = Carbon_automation_test31.AMSize WHERE Carbon_automation_test3.AMSize IN (\"4RAM size\",\"8RAM size\") GROUP BY Carbon_automation_test3.AMSize, Carbon_automation_test3.ActiveCountry, Carbon_automation_test3.Activecity ,Carbon_automation_test3.gamePointId ORDER BY Carbon_automation_test3.AMSize ASC, Carbon_automation_test3.ActiveCountry ASC, Carbon_automation_test3.Activecity ASC"), "TC_612.csv")
  })
  ...
  //TC_712
  test("SELECT Carbon_automation_test3.AMSize AS AMSize, Carbon_automation_test3.ActiveCountry AS ActiveCountry, Carbon_automation_test3.Activecity AS Activecity, SUM(Carbon_automation_test3.gamePointId) AS Sum_gamePointId FROM ( SELECT AMSize, ActiveCountry, Activecity, gamePointId FROM (select * from Carbon_automation_test3) SUB_QRY ) Carbon_automation_test3 INNER JOIN ( SELECT AMSize, ActiveCountry, Activecity, gamePointId FROM (select * from Carbon_automation_test3) SUB_QRY ) Carbon_automation_test31 ON Carbon_automation_test3.gamePointId = Carbon_automation_test31.gamePointId WHERE Carbon_automation_test3.AMSize IS NULL GROUP BY Carbon_automation_test3.AMSize, Carbon_automation_test3.ActiveCountry, Carbon_automation_test3.Activecity ORDER BY Carbon_automation_test3.AMSize ASC, Carbon_automation_test3.ActiveCountry ASC, Carbon_automation_test3.Activecity ASC") ({
    checkAnswer(
      sql("SELECT Carbon_automation_test3.AMSize AS AMSize, Carbon_automation_test3.ActiveCountry AS ActiveCountry, Carbon_automation_test3.Activecity AS Activecity, SUM(Carbon_automation_test3.gamePointId) AS Sum_gamePointId FROM ( SELECT AMSize, ActiveCountry, Activecity, gamePointId FROM (select * from Carbon_automation_test3) SUB_QRY ) Carbon_automation_test3 INNER JOIN ( SELECT AMSize, ActiveCountry, Activecity, gamePointId FROM (select * from Carbon_automation_test3) SUB_QRY ) Carbon_automation_test31 ON Carbon_automation_test3.gamePointId = Carbon_automation_test31.gamePointId WHERE Carbon_automation_test3.AMSize IS NULL GROUP BY Carbon_automation_test3.AMSize, Carbon_automation_test3.ActiveCountry, Carbon_automation_test3.Activecity ORDER BY Carbon_automation_test3.AMSize ASC, Carbon_automation_test3.ActiveCountry ASC, Carbon_automation_test3.Activecity ASC"),
      Seq())
  })
