...
class AllDataTypesTestCase2 extends QueryTest with BeforeAndAfterAll {
  ...
  //Test-23
  test("select channelsId, sum(gamePointId+ 10) Total from Carbon_automation_test2 group by  channelsId order by Total") {
    checkAnswer(
      sql("select channelsId, sum(gamePointId+ 10) Total from Carbon_automation_test2 group by  channelsId order by Total"),
  ...
  //Test-28
  test("select channelsId, avg(gamePointId+ 10) Total from Carbon_automation_test2 group by  channelsId order by Total") {
    checkAnswer(
      sql("select channelsId, avg(gamePointId+ 10) Total from Carbon_automation_test2 group by  channelsId order by Total"),
  ...
  //Test-32
  test("select channelsId, count(gamePointId+ 10) Total from Carbon_automation_test2 group by  channelsId order by Total") {
    checkAnswer(
      sql("select channelsId, count(gamePointId+ 10) Total from Carbon_automation_test2 group by  channelsId order by Total"),
  ...
  //Test-36
  test("select channelsId, min(gamePointId+ 10) Total from Carbon_automation_test2 group by  channelsId order by Total") {
    checkAnswer(
      sql("select channelsId, min(gamePointId+ 10) Total from Carbon_automation_test2 group by  channelsId order by Total"),
  ...
  //Test-40
  test("select channelsId, max(gamePointId+ 10) Total from Carbon_automation_test2 group by  channelsId order by Total") {
    checkAnswer(
      sql("select channelsId, max(gamePointId+ 10) Total from Carbon_automation_test2 group by  channelsId order by Total"),
      Seq(Row("3", 2249), Row("7", 2358), Row("4", 2836), Row("1", 2873), Row("6", 2962), Row("2", 2980), Row("5", 2982)))

  }

  //Test-45
  test("select Latest_YEAR ,count(distinct Latest_YEAR) from Carbon_automation_test2 group by Latest_YEAR")({

    checkAnswer(
      sql("select Latest_YEAR ,count(distinct Latest_YEAR) from Carbon_automation_test2 group by Latest_YEAR"),
      Seq(Row(2015, 1)))
  })
  //TC_053
  ...
  //TC_059
  test("select count(distinct gamepointid)+10 as a,series from Carbon_automation_test2 group by series")({
    checkAnswer(
      sql("select count(distinct gamepointid)+10 as a,series from Carbon_automation_test2 group by series"),
  ...
  //TC_140
  test("select count(distinct deviceColor) a,deliveryProvince,series from Carbon_automation_test2 group by deliveryProvince,series order by deliveryProvince,series")({
    checkAnswer(
      sql("select count(distinct deviceColor) a,deliveryProvince,series from Carbon_automation_test2 group by deliveryProvince,series order by deliveryProvince,series"),
  ...
  //TC_142
  test("select deliveryCountry,deliveryProvince,series,sum(gamePointId) a from Carbon_automation_test2 group by deliveryCountry,deliveryProvince,series order by deliveryCountry,deliveryProvince,series")({
    checkAnswer(
      sql("select deliveryCountry,deliveryProvince,series,sum(gamePointId) a from Carbon_automation_test2 group by deliveryCountry,deliveryProvince,series order by deliveryCountry,deliveryProvince,series"),
  ...
  //TC_146
  test("select series,avg(gamePointId) a from Carbon_automation_test2 group by series order by series")({
    checkAnswer(
      sql("select series,avg(gamePointId) a from Carbon_automation_test2 group by series order by series"),
  ...
  //TC_147
  test("select deliveryCountry,deliveryProvince,series,avg(gamePointId) a from Carbon_automation_test2 group by deliveryCountry,deliveryProvince,series order by deliveryCountry,deliveryProvince,series")({
    checkAnswer(
      sql("select deliveryCountry,deliveryProvince,series,avg(gamePointId) a from Carbon_automation_test2 group by deliveryCountry,deliveryProvince,series order by deliveryCountry,deliveryProvince,series"),
  ...
  //TC_151
  test("select series,min(gamePointId) a from Carbon_automation_test2 group by series order by series")({
    checkAnswer(
      sql("select series,min(gamePointId) a from Carbon_automation_test2 group by series order by series"),
  ...
  //TC_152
  test("select deliveryCountry,deliveryProvince,series,min(gamePointId) a from Carbon_automation_test2 group by deliveryCountry,deliveryProvince,series order by deliveryCountry,deliveryProvince,series")({
    checkAnswer(
      sql("select deliveryCountry,deliveryProvince,series,min(gamePointId) a from Carbon_automation_test2 group by deliveryCountry,deliveryProvince,series order by deliveryCountry,deliveryProvince,series"),
  ...
  //TC_153
  test("select deliveryProvince,series,min(deviceInformationId) a from Carbon_automation_test2 group by deliveryProvince,series order by deliveryProvince,series")({
    checkAnswer(
      sql("select deliveryProvince,series,min(deviceInformationId) a from Carbon_automation_test2 group by deliveryProvince,series order by deliveryProvince,series"),
  ...
  //TC_154
  test("select deliveryProvince,series,min(channelsId) a from Carbon_automation_test2 group by deliveryProvince,series order by deliveryProvince,series")({
    checkAnswer(
      sql("select deliveryProvince,series,min(channelsId) a from Carbon_automation_test2 group by deliveryProvince,series order by deliveryProvince,series"),
  ...
  //TC_155
  test("select deliveryProvince,series,min(bomCode) a from Carbon_automation_test2 group by deliveryProvince,series order by deliveryProvince,series")({
    checkAnswer(
      sql("select deliveryProvince,series,min(bomCode) a from Carbon_automation_test2 group by deliveryProvince,series order by deliveryProvince,series"),
  ...
  //TC_156
  test("select series,max(gamePointId) a from Carbon_automation_test2 group by series order by series")({
    checkAnswer(
      sql("select series,max(gamePointId) a from Carbon_automation_test2 group by series order by series"),
  ...
  //TC_157
  test("select deliveryCountry,deliveryProvince,series,max(gamePointId) a from Carbon_automation_test2 group by deliveryCountry,deliveryProvince,series order by deliveryCountry,deliveryProvince,series")({
    checkAnswer(
      sql("select deliveryCountry,deliveryProvince,series,max(gamePointId) a from Carbon_automation_test2 group by deliveryCountry,deliveryProvince,series order by deliveryCountry,deliveryProvince,series"),
  ...
  //TC_158
  test("select deliveryProvince,series,max(deviceInformationId) a from Carbon_automation_test2 group by deliveryProvince,series order by deliveryProvince,series")({
    checkAnswer(
      sql("select deliveryProvince,series,max(deviceInformationId) a from Carbon_automation_test2 group by deliveryProvince,series order by deliveryProvince,series"),
  ...
  //TC_159
  test("select deliveryProvince,series,max(channelsId) a from Carbon_automation_test2 group by deliveryProvince,series order by deliveryProvince,series")({
    checkAnswer(
      sql("select deliveryProvince,series,max(channelsId) a from Carbon_automation_test2 group by deliveryProvince,series order by deliveryProvince,series"),
  ...
  //TC_160
  test("select deliveryProvince,series,max(bomCode) a from Carbon_automation_test2 group by deliveryProvince,series order by deliveryProvince,series")({
    checkAnswer(
      sql("select deliveryProvince,series,max(bomCode) a from Carbon_automation_test2 group by deliveryProvince,series order by deliveryProvince,series"),
  ...
  //TC_192
  test("select imei from Carbon_automation_test2 where  (contractNumber == 5281803) and (gamePointId==2738.562)1 ")({
    checkAnswer(
      sql("select imei from Carbon_automation_test2 where  (contractNumber == 5281803) and (gamePointId==2738.562)"),
      Seq(Row("1AA1")))
  })

  //TC_193
  test("select contractNumber,gamePointId,series from Carbon_automation_test2 where  (contractNumber == 5281803) and (gamePointId==2738.562)")({
    checkAnswer(
      sql("select contractNumber,gamePointId,series from Carbon_automation_test2 where  (contractNumber == 5281803) and (gamePointId==2738.562)"),
      Seq(Row(5281803.0, 2738.562, "7Series")))
  })

  //TC_194
  test("select contractNumber,gamePointId,series from Carbon_automation_test2 where series='8Series'")({
    checkAnswer(
      sql("select contractNumber,gamePointId,series from Carbon_automation_test2 where series='8Series'"),
  ...
  //TC_195
  test("select contractNumber,gamePointId,series from Carbon_automation_test2 where series='8Series' and internalModels='8Internal models'")({
    checkAnswer(
      sql("select contractNumber,gamePointId,series from Carbon_automation_test2 where series='8Series' and internalModels='8Internal models'"),
      Seq(Row(1070757.0, 1442.0, "8Series"), Row(7880439.0, 2078.0, "8Series")))
  })

  //TC_196
  test("select contractNumber,gamePointId,series from Carbon_automation_test2 where series='8Series' or  internalModels='8Internal models'")({
    checkAnswer(
      sql("select contractNumber,gamePointId,series from Carbon_automation_test2 where series='8Series' or  internalModels='8Internal models'"),
  ...
  //TC_197
  test("select contractNumber,gamePointId,series from Carbon_automation_test2 where series='8Series' or series='7Series'")({
    checkAnswer(
      sql("select contractNumber,gamePointId,series from Carbon_automation_test2 where series='8Series' or series='7Series'"),
  ...
  //TC_198
  test("select contractNumber,gamePointId,series from Carbon_automation_test2 where gamePointId=2738.562")({
    checkAnswer(
      sql("select contractNumber,gamePointId,series from Carbon_automation_test2 where gamePointId=2738.562"),
      Seq(Row(5281803.0, 2738.562, "7Series")))
  })

  //TC_199
  test("select contractNumber,gamePointId,series from Carbon_automation_test2 where deviceInformationId=10")({
    checkAnswer(
      sql("select contractNumber,gamePointId,series from Carbon_automation_test2 where deviceInformationId=10"),
      Seq(Row(6805600.0, 1714.635, "7Series")))
  })

  //TC_200
  test("select contractNumber,gamePointId,series  from Carbon_automation_test2 where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')")({
    checkAnswer(
      sql("select contractNumber,gamePointId,series  from Carbon_automation_test2 where (deviceInformationId=100 and deviceColor='1Device Color') OR (deviceInformationId=10 and deviceColor='0Device Color')"),
  ...
  //TC_217
  test("select imei, Latest_DAY from Carbon_automation_test2 where Latest_DAY BETWEEN Latest_areaId AND  Latest_HOUR")({
    checkAnswer(
      sql("select imei, Latest_DAY from Carbon_automation_test2 where Latest_DAY BETWEEN Latest_areaId AND  Latest_HOUR"),
  ...
  //TC_221
  test("select imei, Latest_DAY from Carbon_automation_test2 where Latest_DAY NOT LIKE Latest_areaId AND Latest_DAY NOT LIKE  Latest_HOUR")({
    checkAnswer(
      sql("select imei, Latest_DAY from Carbon_automation_test2 where Latest_DAY NOT LIKE Latest_areaId AND Latest_DAY NOT LIKE  Latest_HOUR"),
  ...
  //TC_238
  test("select imei from Carbon_automation_test2 where  (contractNumber == 5281803) and (gamePointId==2738.562)")({
    checkAnswer(
      sql("select imei from Carbon_automation_test2 where  (contractNumber == 5281803) and (gamePointId==2738.562)"),
      Seq(Row("1AA1")))
  })
  ...
  //TC_239
  test("select deliveryCity from Carbon_automation_test2 where  (deliveryCity == 'yichang') and ( deliveryStreet=='yichang')")({
    checkAnswer(
      sql("select deliveryCity from Carbon_automation_test2 where  (deliveryCity == 'yichang') and ( deliveryStreet=='yichang')"),
  ...
  //TC_240
  test("select channelsId  from Carbon_automation_test2 where  (channelsId == '4') and (gamePointId==2738.562)")({
    checkAnswer(
      sql("select channelsId  from Carbon_automation_test2 where  (channelsId == '4') and (gamePointId==2738.562)"),
      Seq(Row("4")))
  })

  //TC_241
  test("select imei from Carbon_automation_test2 where  (contractNumber == 5281803) OR (gamePointId==2738.562) order by contractNumber")({
    checkAnswer(
      sql("select imei from Carbon_automation_test2 where  (contractNumber == 5281803) OR (gamePointId==2738.562) order by contractNumber"),
      Seq(Row("1AA1")))
  })

  //TC_242
  test("select channelsId from Carbon_automation_test2 where  (channelsId == '4') OR (gamePointId==2738.562) order by channelsId")({
    checkAnswer(
      sql("select channelsId from Carbon_automation_test2 where  (channelsId == '4') OR (gamePointId==2738.562) order by channelsId"),
      Seq(Row("4"), Row("4"), Row("4"), Row("4"), Row("4"), Row("4"), Row("4"), Row("4"), Row("4"), Row("4"), Row("4"), Row("4")))
  })

  //TC_243
  test("select deliveryCity  from Carbon_automation_test2 where  (deliveryCity == 'yichang') OR ( deliveryStreet=='yichang') order by deliveryCity")({
    checkAnswer(
      sql("select deliveryCity  from Carbon_automation_test2 where  (deliveryCity == 'yichang') OR ( deliveryStreet=='yichang') order by deliveryCity"),
      Seq(Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang")))
  })

  //TC_244
  test("select imei, gamePointId from Carbon_automation_test2 where contractNumber in (5281803) and gamePointId IN (2738.562) ORDER BY gamePointId")({
    checkAnswer(
      sql("select imei, gamePointId from Carbon_automation_test2 where contractNumber in (5281803) and gamePointId IN (2738.562) ORDER BY gamePointId"),
      Seq(Row("1AA1", 2738.562)))
  })

  //TC_245
  test("select channelsId from Carbon_automation_test2 where  channelsId in ('4') or gamePointId IN (2738.562) ORDER BY channelsId")({
    checkAnswer(
      sql("select channelsId from Carbon_automation_test2 where  channelsId in ('4') or gamePointId IN (2738.562) ORDER BY channelsId"),
      Seq(Row("4"), Row("4"), Row("4"), Row("4"), Row("4"), Row("4"), Row("4"), Row("4"), Row("4"), Row("4"), Row("4"), Row("4")))
  })

  //TC_246
  test("select deliveryCity from Carbon_automation_test2 where  deliveryCity IN ('yichang') AND  deliveryStreet IN ('yichang') ORDER BY deliveryCity")({
    checkAnswer(
      sql("select deliveryCity from Carbon_automation_test2 where  deliveryCity IN ('yichang') AND  deliveryStreet IN ('yichang') ORDER BY deliveryCity"),
      Seq(Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang"), Row("yichang")))
  })

  //TC_247
  test("select imei,gamePointId, channelsId,series from Carbon_automation_test2 where  channelsId > 4 ORDER BY gamePointId limit 5")({
    checkAnswer(
      sql("select imei,gamePointId, channelsId,series from Carbon_automation_test2 where  channelsId > 4 ORDER BY gamePointId limit 5"),
  ...
  //TC_251
  test("select imei,gamePointId, channelsId,series from Carbon_automation_test2 where  channelsId BETWEEN 4 AND 5 ORDER BY gamePointId limit 5")({
    checkAnswer(
      sql("select imei,gamePointId, channelsId,series from Carbon_automation_test2 where  channelsId BETWEEN 4 AND 5 ORDER BY gamePointId limit 5"),
  ...
  //TC_252
  test("select imei,gamePointId, channelsId,series from Carbon_automation_test2 where  channelsId NOT BETWEEN 4 AND 5 ORDER BY gamePointId limit 5")({
    checkAnswer(
      sql("select imei,gamePointId, channelsId,series from Carbon_automation_test2 where  channelsId NOT BETWEEN 4 AND 5 ORDER BY gamePointId limit 5"),
  ...
  //TC_253
  test("select imei,gamePointId, channelsId,series from Carbon_automation_test2 where  channelsId LIKE 4 ORDER BY gamePointId limit 5")({
    checkAnswer(
      sql("select imei,gamePointId, channelsId,series from Carbon_automation_test2 where  channelsId LIKE 4 ORDER BY gamePointId limit 5"),
  ...
  //TC_254
  test("select imei,gamePointId, channelsId,series from Carbon_automation_test2 where  channelsId NOT LIKE 4 AND channelsId NOT LIKE 5 ORDER BY gamePointId limit 5")({
    checkAnswer(
      sql("select imei,gamePointId, channelsId,series from Carbon_automation_test2 where  channelsId NOT LIKE 4 AND channelsId NOT LIKE 5 ORDER BY gamePointId limit 5"),
      Seq(Row("1AA100050", 29.0, "1", "2Series"), Row("1AA100010", 79.0, "6", "3Series"), Row("1AA100000", 136.0, "6", "9Series"), Row("1AA100014", 151.0, "3", "5Series"), Row("1AA100011", 202.0, "1", "0Series")))
  })

  //TC_255
  test("select imei,gamePointId, channelsId,series from Carbon_automation_test2 where  channelsId RLIKE 4 ORDER BY gamePointId limit 5")({
    checkAnswer(
      sql("select imei,gamePointId, channelsId,series from Carbon_automation_test2 where  channelsId RLIKE 4 ORDER BY gamePointId limit 5"),
      Seq(Row("1AA100018", 441.0, "4", "8Series"), Row("1AA100060", 538.0, "4", "8Series"), Row("1AA10008", 813.0, "4", "5Series"), Row("1AA100046", 1077.0, "4", "3Series"), Row("1AA10", 1714.635, "4", "7Series")))
  })

  //TC_256
  test("select imei,gamePointId, channelsId,series from Carbon_automation_test2 where  channelsId NOT RLIKE 4 AND channelsId NOT RLIKE 5 ORDER BY gamePointId limit 5")({
    checkAnswer(
      sql("select imei,gamePointId, channelsId,series from Carbon_automation_test2 where  channelsId NOT RLIKE 4 AND channelsId NOT RLIKE 5 ORDER BY gamePointId limit 5"),
      Seq(Row("1AA100050", 29.0, "1", "2Series"), Row("1AA100010", 79.0, "6", "3Series"), Row("1AA100000", 136.0, "6", "9Series"), Row("1AA100014", 151.0, "3", "5Series"), Row("1AA100011", 202.0, "1", "0Series")))
  })

  //TC_257
  test("select imei,internalModels,series from Carbon_automation_test2 where (series='8Series' and internalModels='8Internal models') OR (series='7Series' and internalModels='7Internal models')")({
    checkAnswer(
      sql("select imei,internalModels,series from Carbon_automation_test2 where (series='8Series' and internalModels='8Internal models') OR (series='7Series' and internalModels='7Internal models')"),
  ...
  //TC_258
  test("select imei,internalModels,series from Carbon_automation_test2 where (series='8Series' or internalModels='8Internal models') or (series='7Series' or internalModels='7Internal models')")({
    checkAnswer(
      sql("select imei,internalModels,series from Carbon_automation_test2 where (series='8Series' or internalModels='8Internal models') or (series='7Series' or internalModels='7Internal models')"),
  ...
  //TC_259
  test("select imei,internalModels,series from Carbon_automation_test2 where (series='8Series' or internalModels='8Internal models') and (series='7Series' or internalModels='7Internal models')")({
    checkAnswer(
      sql("select imei,internalModels,series from Carbon_automation_test2 where (series='8Series' or internalModels='8Internal models') and (series='7Series' or internalModels='7Internal models')"),
      Seq(Row("1AA100055", "8Internal models", "7Series"), Row("1AA10007", "7Internal models", "8Series")))
  })

  //TC_260
  test("select imei,internalModels,series from Carbon_automation_test2 where (series='8Series' and internalModels='8Internal models') or (deviceInformationId is not NULL)")({
    checkAnswer(
      sql("select imei,internalModels,series from Carbon_automation_test2 where (series='8Series' and internalModels='8Internal models') or (deviceInformationId is not NULL)"),
  ...
  //TC_261
  test("select  imei from Carbon_automation_test2 where UPPER(Latest_province) == 'GUANGDONG PROVINCE'")({
    checkAnswer(
      sql("select  imei from Carbon_automation_test2 where UPPER(Latest_province) == 'GUANGDONG PROVINCE'"),
  ...
  //TC_266
  test("SELECT AMSize, ActiveAreaId, SUM(gamePointId) AS Sum_gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY WHERE AMSize > \"\" GROUP BY AMSize, ActiveAreaId ORDER BY AMSize ASC, ActiveAreaId ASC")({
    checkAnswer(
      sql("SELECT AMSize, ActiveAreaId, SUM(gamePointId) AS Sum_gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY WHERE AMSize > \"\" GROUP BY AMSize, ActiveAreaId ORDER BY AMSize ASC, ActiveAreaId ASC"),
  ...
  //TC_267
  test("SELECT AMSize, ActiveAreaId, SUM(gamePointId) AS Sum_gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY WHERE AMSize > \"1RAM size\" GROUP BY AMSize, ActiveAreaId ORDER BY AMSize ASC, ActiveAreaId ASC")({
    checkAnswer(
      sql("SELECT AMSize, ActiveAreaId, SUM(gamePointId) AS Sum_gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY WHERE AMSize > \"1RAM size\" GROUP BY AMSize, ActiveAreaId ORDER BY AMSize ASC, ActiveAreaId ASC"),
  ...
  //TC_269
  test("SELECT AMSize, ActiveAreaId, SUM(gamePointId) AS Sum_gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY WHERE AMSize >= \"0RAM size\" GROUP BY AMSize, ActiveAreaId ORDER BY AMSize ASC, ActiveAreaId ASC")({
    checkAnswer(
      sql("SELECT AMSize, ActiveAreaId, SUM(gamePointId) AS Sum_gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY WHERE AMSize >= \"0RAM size\" GROUP BY AMSize, ActiveAreaId ORDER BY AMSize ASC, ActiveAreaId ASC"),
      Seq(Row("0RAM size", "1", 2849.0), Row("0RAM size", "2", 79.0), Row("0RAM size", "3", 7663.0), Row("0RAM size", "5", 1341.0), Row("0RAM size", "6", 6082.0), Row("1RAM size", "1", 256.0), Row("1RAM size", "2", 1333.0), Row("1RAM size", "4", 7510.0), Row("1RAM size", "5", 2745.0), Row("1RAM size", "7", 3942.0), Row("2RAM size", "3", 1973.0), Row("2RAM size", "4", 1350.0), Row("3RAM size", "1", 6640.0), Row("3RAM size", "2", 1999.0), Row("3RAM size", "3", 2863.0), Row("3RAM size", "4", 3824.0), Row("3RAM size", "5", 5699.0), Row("3RAM size", "6", 2635.0), Row("3RAM size", "7", 1491.0), Row("4RAM size", "1", 2255.0), Row("4RAM size", "2", 1728.0), Row("4RAM size", "3", 9130.0), Row("4RAM size", "4", 11560.0), Row("4RAM size", "6", 5344.635), Row("4RAM size", "7", 1338.0), Row("5RAM size", "2", 4712.0), Row("5RAM size", "3", 2769.0), Row("5RAM size", "6", 2478.0), Row("6RAM size", "1", 2142.0), Row("6RAM size", "2", 1768.0), Row("6RAM size", "3", 2633.0), Row("6RAM size", "4", 866.0), Row("6RAM size", "5", 2952.0), Row("6RAM size", "6", 3257.0), Row("7RAM size", "3", 151.0), Row("7RAM size", "5", 2239.0), Row("7RAM size", "6", 3979.0), Row("7RAM size", "7", 2031.0), Row("8RAM size", "1", 355.0), Row("8RAM size", "2", 2738.562), Row("8RAM size", "4", 3102.0), Row("8RAM size", "5", 2684.0), Row("8RAM size", "6", 2970.0), Row("8RAM size", "7", 5166.0), Row("9RAM size", "1", 3065.0), Row("9RAM size", "3", 3239.0), Row("9RAM size", "4", 5821.0), Row("9RAM size", "6", 1567.0), Row("9RAM size", "7", 571.0)))
  })

  //TC_271
  test("SELECT ActiveCountry, ActiveDistrict, ActiveOperatorId, ActiveProvince, ActiveStreet FROM (select * from Carbon_automation_test2) SUB_QRY GROUP BY ActiveCountry, ActiveDistrict, ActiveOperatorId, ActiveProvince, ActiveStreet ORDER BY ActiveCountry ASC, ActiveDistrict ASC, ActiveOperatorId ASC, ActiveProvince ASC, ActiveStreet ASC")({
    checkAnswer(
      sql("SELECT ActiveCountry, ActiveDistrict, ActiveOperatorId, ActiveProvince, ActiveStreet FROM (select * from Carbon_automation_test2) SUB_QRY GROUP BY ActiveCountry, ActiveDistrict, ActiveOperatorId, ActiveProvince, ActiveStreet ORDER BY ActiveCountry ASC, ActiveDistrict ASC, ActiveOperatorId ASC, ActiveProvince ASC, ActiveStreet ASC"),
  ...
  //TC_272
  test("SELECT ActiveCountry, ActiveDistrict, ActiveOperatorId, ActiveProvince, ActiveStreet, SUM(gamePointId) AS Sum_gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY GROUP BY ActiveCountry, ActiveDistrict, ActiveOperatorId, ActiveProvince, ActiveStreet ORDER BY ActiveCountry ASC, ActiveDistrict ASC, ActiveOperatorId ASC, ActiveProvince ASC, ActiveStreet ASC")({
    checkAnswer(
      sql("SELECT ActiveCountry, ActiveDistrict, ActiveOperatorId, ActiveProvince, ActiveStreet, SUM(gamePointId) AS Sum_gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY GROUP BY ActiveCountry, ActiveDistrict, ActiveOperatorId, ActiveProvince, ActiveStreet ORDER BY ActiveCountry ASC, ActiveDistrict ASC, ActiveOperatorId ASC, ActiveProvince ASC, ActiveStreet ASC"),
  ...
  //TC_277
  test("SELECT Activecity, ActiveCountry, ActiveDistrict, MAX(gamepointid) AS Max_gmaepointid FROM (select * from Carbon_automation_test2) SUB_QRY GROUP BY Activecity, ActiveCountry, ActiveDistrict ORDER BY Activecity ASC, ActiveCountry ASC, ActiveDistrict ASC")({
    checkAnswer(
      sql("SELECT Activecity, ActiveCountry, ActiveDistrict, MAX(gamepointid) AS Max_gmaepointid FROM (select * from Carbon_automation_test2) SUB_QRY GROUP BY Activecity, ActiveCountry, ActiveDistrict ORDER BY Activecity ASC, ActiveCountry ASC, ActiveDistrict ASC"),
  ...
  //TC_278
  test("SELECT Activecity, ActiveCountry, ActiveDistrict, MIN(gamepointid) AS Min_gamepointid FROM (select * from Carbon_automation_test2) SUB_QRY GROUP BY Activecity, ActiveCountry, ActiveDistrict ORDER BY Activecity ASC, ActiveCountry ASC, ActiveDistrict ASC")({
    checkAnswer(
      sql("SELECT Activecity, ActiveCountry, ActiveDistrict, MIN(gamepointid) AS Min_gamepointid FROM (select * from Carbon_automation_test2) SUB_QRY GROUP BY Activecity, ActiveCountry, ActiveDistrict ORDER BY Activecity ASC, ActiveCountry ASC, ActiveDistrict ASC"),
  ...
  //TC_283
  test("select  AMSize,sum( gamePointId+ contractNumber) as total from Carbon_automation_test2 where AMSize='0RAM size' and  ActiveProvince='Guangdong Province' group by AMSize")({
    checkAnswer(
      sql("select  AMSize,sum( gamePointId+ contractNumber) as total from Carbon_automation_test2 where AMSize='0RAM size' and  ActiveProvince='Guangdong Province' group by AMSize"),
      Seq(Row("0RAM size", 1.742632E7)))
  })

  //TC_284
  test("select AMSize,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where  CUPAudit='0CPU Audit' group by AMSize having total > 10 order by total desc")({
    checkAnswer(
      sql("select AMSize,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where  CUPAudit='0CPU Audit' group by AMSize having total > 10 order by total desc"),
  ...
  //TC_286
  test("select  ActiveAreaId,count(distinct AMSize) as AMSize_number, sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by ActiveAreaId")({
    checkAnswer(
      sql("select  ActiveAreaId,count(distinct AMSize) as AMSize_number, sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by ActiveAreaId"),
  ...
  //TC_287
  test("select ActiveAreaId,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where ActiveAreaId='6'group by ActiveAreaId order by AMSize_number desc")({
    checkAnswer(
      sql("select ActiveAreaId,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where ActiveAreaId='6'group by ActiveAreaId order by AMSize_number desc"),
  ...
  //TC_289
  test("select ActiveAreaId,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where ActiveAreaId='6' and ActiveProvince='Hubei Province' group by ActiveAreaId order by AMSize_number desc")({
    checkAnswer(
      sql("select ActiveAreaId,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where ActiveAreaId='6' and ActiveProvince='Hubei Province' group by ActiveAreaId order by AMSize_number desc"),
      Seq(Row("6", 8, 7.662756463499999E7)))
  })

  //TC_290
  test("select ActiveProvince,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by ActiveProvince1")({
    checkAnswer(
      sql("select ActiveProvince,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by ActiveProvince"),
      Seq(Row("Hunan Province", 10, 2.41456223E8), Row("Guangdong Province", 8, 9.0048892562E7), Row("Hubei Province", 9, 1.43841659635E8)))
  })

  //TC_291
  test("select AMSize,count(distinct imei) as imei_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where AMSize='0RAM size' group by AMSize order by imei_number desc")({
    checkAnswer(
      sql("select AMSize,count(distinct imei) as imei_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where AMSize='0RAM size' group by AMSize order by imei_number desc"),
      Seq(Row("0RAM size", 11, 5.437552E7)))
  })

  //TC_292
  test("select ActiveProvince,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by ActiveProvince")({
    checkAnswer(
      sql("select ActiveProvince,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by ActiveProvince"),
      Seq(Row("Hunan Province", 10, 2.41456223E8), Row("Guangdong Province", 8, 9.0048892562E7), Row("Hubei Province", 9, 1.43841659635E8)))
  })
  ...
  //TC_293
  test("select ActiveProvince,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where CUPAudit='0CPU Audit' group by ActiveProvince order by total desc")({
    checkAnswer(
      sql("select ActiveProvince,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where CUPAudit='0CPU Audit' group by ActiveProvince order by total desc"),
      Seq(Row("Hubei Province", 3, 2.3775647E7), Row("Hunan Province", 3, 2.3622422E7), Row("Guangdong Province", 3, 1.8366698562E7)))
  })

  //TC_294
  test("select  ActiveOperatorId,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by  ActiveOperatorId")({
    checkAnswer(
      sql("select  ActiveOperatorId,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by  ActiveOperatorId"),
  ...
  //TC_295
  test("select ActiveOperatorId,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where ActiveOperatorId='100000' group by ActiveOperatorId order by total desc")({
    checkAnswer(
      sql("select ActiveOperatorId,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where ActiveOperatorId='100000' group by ActiveOperatorId order by total desc"),
      Seq(Row("100000", 1, 1602594.0)))
  })

  //TC_296
  test("select ActiveAreaId,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by ActiveAreaId1")({
    checkAnswer(
      sql("select ActiveAreaId,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by ActiveAreaId"),
      Seq(Row("1", 7, 4.8863556E7), Row("2", 7, 4.1185336562E7), Row("3", 8, 1.00876754E8), Row("4", 7, 1.02219772E8), Row("5", 6, 3.8359697E7), Row("6", 8, 7.662756463499999E7), Row("7", 6, 6.7214095E7)))
  })
  ...
  //TC_297
  test("select  Latest_DAY,Latest_HOUR,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by Latest_DAY,Latest_HOUR")({
    checkAnswer(
      sql("select  Latest_DAY,Latest_HOUR,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by Latest_DAY,Latest_HOUR"),
      Seq(Row(1, "12", 10, 4.75346775197E8)))
  })

  //TC_298
  test("select Latest_DAY,Latest_HOUR,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where Latest_HOUR between 12 and 15 group by Latest_DAY,Latest_HOUR order by total desc")({
    checkAnswer(
      sql("select Latest_DAY,Latest_HOUR,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where Latest_HOUR between 12 and 15 group by Latest_DAY,Latest_HOUR order by total desc"),
      Seq(Row(1, "12", 10, 4.75346775197E8)))
  })

  //TC_299
  test("select  Activecity,ActiveProvince,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by Activecity,ActiveProvince")({
    checkAnswer(
      sql("select  Activecity,ActiveProvince,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by Activecity,ActiveProvince"),
  ...
  //TC_300
  test("select Activecity,ActiveProvince,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where  ActiveProvince='Guangdong Province' group by Activecity,ActiveProvince order by total desc")({
    checkAnswer(
      sql("select Activecity,ActiveProvince,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where  ActiveProvince='Guangdong Province' group by Activecity,ActiveProvince order by total desc"),
      Seq(Row("shenzhen", "Guangdong Province", 7, 4.8863556E7), Row("guangzhou", "Guangdong Province", 7, 4.1185336562E7)))
  })

  //TC_301
  test("select ActiveOperatorId,Activecity,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by Activecity,ActiveOperatorId")({
    checkAnswer(
      sql("select ActiveOperatorId,Activecity,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by Activecity,ActiveOperatorId"),
  ...
  //TC_302
  test("select ActiveOperatorId,Activecity,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where  ActiveAreaId='6' and ActiveOperatorId='100004' group by ActiveOperatorId,Activecity order by total desc")({
    checkAnswer(
      sql("select ActiveOperatorId,Activecity,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where  ActiveAreaId='6' and ActiveOperatorId='100004' group by ActiveOperatorId,Activecity order by total desc"),
      Seq(Row("100004", "wuhan", 1, 1442333.0)))
  })

  //TC_303
  test("select ActiveAreaId,Activecity,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2  group by Activecity,ActiveAreaId1")({
    checkAnswer(
      sql("select ActiveAreaId,Activecity,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2  group by Activecity,ActiveAreaId"),
  ...
  //TC_304
  test("select ActiveAreaId,Activecity,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where  ActiveAreaId='6' group by Activecity,ActiveAreaId order by total desc")({
    checkAnswer(
      sql("select ActiveAreaId,Activecity,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where  ActiveAreaId='6' group by Activecity,ActiveAreaId order by total desc"),
      Seq(Row("6", "wuhan", 8, 7.662756463499999E7)))
  })

  //TC_305
  test("select ActiveAreaId,Activecity,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2  group by Activecity,ActiveAreaId")({
    checkAnswer(
      sql("select ActiveAreaId,Activecity,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2  group by Activecity,ActiveAreaId"),
      Seq(Row("1", "shenzhen", 7, 4.8863556E7), Row("5", "zhuzhou", 6, 3.8359697E7), Row("6", "wuhan", 8, 7.662756463499999E7), Row("3", "changsha", 8, 1.00876754E8), Row("2", "guangzhou", 7, 4.1185336562E7), Row("7", "yichang", 6, 6.7214095E7), Row("4", "xiangtan", 7, 1.02219772E8)))
  })
  ...
  //TC_306
  test("select ActiveAreaId,Activecity,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where  ActiveOperatorId in('100000','100004') group by Activecity,ActiveAreaId order by total desc")({
    checkAnswer(
      sql("select ActiveAreaId,Activecity,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 where  ActiveOperatorId in('100000','100004') group by Activecity,ActiveAreaId order by total desc"),
      Seq(Row("7", "yichang", 1, 1602594.0), Row("6", "wuhan", 1, 1442333.0)))
  })

  //TC_307
  test("select ActiveOperatorId,ActiveAreaId,Activecity,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by ActiveOperatorId,Activecity,ActiveAreaId")({
    checkAnswer(
      sql("select ActiveOperatorId,ActiveAreaId,Activecity,count(distinct AMSize) as AMSize_number,sum(gamePointId+contractNumber) as total from Carbon_automation_test2 group by ActiveOperatorId,Activecity,ActiveAreaId"),
  ...
  //TC_308
  test("select t2.AMSize,t1.Activecity,count(t1.AMSize) as AMSize_number,sum(t1.gamePointId+t1.contractNumber) as total from Carbon_automation_test2 t1, Carbon_automation_test2 t2 where t1.AMSize=t2.AMSize group by t1.Activecity,t2.AMSize")({
    checkAnswer(
      sql("select t2.AMSize,t1.Activecity,count(t1.AMSize) as AMSize_number,sum(t1.gamePointId+t1.contractNumber) as total from Carbon_automation_test2 t1, Carbon_automation_test2 t2 where t1.AMSize=t2.AMSize group by t1.Activecity,t2.AMSize"),
  ...
  //TC_309
  test("select t2.AMSize,t1.Activecity,count(t1.AMSize) as AMSize_number,sum(t1.gamePointId+t1.contractNumber) as total from Carbon_automation_test2 t1, Carbon_automation_test2 t2 where t1.ActiveOperatorId='100004' and t1.AMSize=t2.AMSize group by t1.Activecity,t2.AMSize")({
    checkAnswer(
      sql("select t2.AMSize,t1.Activecity,count(t1.AMSize) as AMSize_number,sum(t1.gamePointId+t1.contractNumber) as total from Carbon_automation_test2 t1, Carbon_automation_test2 t2 where t1.ActiveOperatorId='100004' and t1.AMSize=t2.AMSize group by t1.Activecity,t2.AMSize"),
      Seq(Row("8RAM size", "wuhan", 10, 1.442333E7)))
  })

  //TC_310
  test("select t2.AMSize,t1.Activecity,count(t1.AMSize) as AMSize_number,sum(t1.gamePointId+t1.contractNumber) as total from Carbon_automation_test2 t1, Carbon_automation_test2 t2 where t1.ActiveOperatorId='100004' and t1.AMSize=t2.AMSize group by t1.Activecity,t2.AMSize order by total desc")({
    checkAnswer(
      sql("select t2.AMSize,t1.Activecity,count(t1.AMSize) as AMSize_number,sum(t1.gamePointId+t1.contractNumber) as total from Carbon_automation_test2 t1, Carbon_automation_test2 t2 where t1.ActiveOperatorId='100004' and t1.AMSize=t2.AMSize group by t1.Activecity,t2.AMSize order by total desc"),
      Seq(Row("8RAM size", "wuhan", 10, 1.442333E7)))
  })

  //TC_311
  test("select t2.AMSize,t1.ActiveAreaId,count(t1.AMSize) as AMSize_number,sum(t1.gamePointId+t1.contractNumber) as total from Carbon_automation_test2 t1, Carbon_automation_test2 t2 where t1.AMSize=t2.AMSize group by t1.ActiveAreaId,t2.AMSize")({
    checkAnswer(
      sql("select t2.AMSize,t1.ActiveAreaId,count(t1.AMSize) as AMSize_number,sum(t1.gamePointId+t1.contractNumber) as total from Carbon_automation_test2 t1, Carbon_automation_test2 t2 where t1.AMSize=t2.AMSize group by t1.ActiveAreaId,t2.AMSize"),
  ...
  //TC_312
  test("select ActiveOperatorId, sum(imeiupdown) as total, count(distinct AMSize) as AMSize_count from (select AMSize, t1.gamePointId+t1.contractNumber as imeiupdown, if((t1.gamePointId+t1.contractNumber)>100, '>50', if((t1.gamePointId+t1.contractNumber)>100,'50~10',if((t1.gamePointId+t1.contractNumber)>100, '10~1','<1'))) as ActiveOperatorId from Carbon_automation_test2 t1) t2 group by ActiveOperatorId")({
    checkAnswer(
      sql("select ActiveOperatorId, sum(imeiupdown) as total, count(distinct AMSize) as AMSize_count from (select AMSize, t1.gamePointId+t1.contractNumber as imeiupdown, if((t1.gamePointId+t1.contractNumber)>100, '>50', if((t1.gamePointId+t1.contractNumber)>100,'50~10',if((t1.gamePointId+t1.contractNumber)>100, '10~1','<1'))) as ActiveOperatorId from Carbon_automation_test2 t1) t2 group by ActiveOperatorId"),
  ...
  //TC_314
  test("SELECT AMSize, ActiveAreaId, SUM(gamepointid) AS Sum_gamepointid FROM (select * from Carbon_automation_test2) SUB_QRY WHERE AMSize BETWEEN \"0RAM size\" AND \"1RAM size\" GROUP BY AMSize, ActiveAreaId ORDER BY AMSize ASC, ActiveAreaId ASC")({
    checkAnswer(
      sql("SELECT AMSize, ActiveAreaId, SUM(gamepointid) AS Sum_gamepointid FROM (select * from Carbon_automation_test2) SUB_QRY WHERE AMSize BETWEEN \"0RAM size\" AND \"1RAM size\" GROUP BY AMSize, ActiveAreaId ORDER BY AMSize ASC, ActiveAreaId ASC"),
  ...
  //TC_315
  test("SELECT AMSize, ActiveAreaId, imei FROM (select * from Carbon_automation_test2) SUB_QRY WHERE  Latest_DAY BETWEEN 1 AND 1")({
    checkAnswer(
      sql("SELECT AMSize, ActiveAreaId, imei FROM (select * from Carbon_automation_test2) SUB_QRY WHERE  Latest_DAY BETWEEN 1 AND 1"),
  ...
  //TC_316
  test("select series,gamepointid from Carbon_automation_test2 where gamepointid between 1407 and 1407")({
    checkAnswer(
      sql("select series,gamepointid from Carbon_automation_test2 where gamepointid between 1407 and 1407"),
      Seq(Row("2Series", 1407.0), Row("6Series", 1407.0)))
  })

  //TC_327
  test("SELECT imei, deliveryCity, COUNT(Latest_YEAR) AS Count_Latest_YEAR, SUM(gamePointId) AS Sum_gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY WHERE imei >= \"1AA1000000\" GROUP BY imei, deliveryCity ORDER BY imei ASC, deliveryCity ASC")({
    checkAnswer(
      sql("SELECT imei, deliveryCity, COUNT(Latest_YEAR) AS Count_Latest_YEAR, SUM(gamePointId) AS Sum_gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY WHERE imei >= \"1AA1000000\" GROUP BY imei, deliveryCity ORDER BY imei ASC, deliveryCity ASC"),
  ...
  //TC_329
  test("SELECT imei, deliveryCity, series, SUM(gamePointId) AS Sum_gamePointId, COUNT(Latest_DAY) AS Count_Latest_DAY FROM (select * from Carbon_automation_test2) SUB_QRY WHERE imei >= \"1AA1000000\" GROUP BY imei, deliveryCity, series ORDER BY imei ASC, deliveryCity ASC, series ASC")({
    checkAnswer(
      sql("SELECT imei, deliveryCity, series, SUM(gamePointId) AS Sum_gamePointId, COUNT(Latest_DAY) AS Count_Latest_DAY FROM (select * from Carbon_automation_test2) SUB_QRY WHERE imei >= \"1AA1000000\" GROUP BY imei, deliveryCity, series ORDER BY imei ASC, deliveryCity ASC, series ASC"),
  ...
  //TC_340
  test("SELECT latest_year, latest_day, imei, gamepointid, deviceinformationid, series, imei, deliverycity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(gamepointid > 2000.0)")({
    checkAnswer(
      sql("SELECT latest_year, latest_day, imei, gamepointid, deviceinformationid, series, imei, deliverycity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(gamepointid > 2000.0)"),
  ...
  //TC_341
  test("SELECT gamePointId, deviceInformationId, Latest_YEAR, series, imei, deliveryCity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE imei = \"1AA10000\"")({
    checkAnswer(
      sql("SELECT gamePointId, deviceInformationId, Latest_YEAR, series, imei, deliveryCity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE imei = \"1AA10000\""),
      Seq(Row(2175.0, 10000, 2015, "7Series", "1AA10000", "guangzhou")))
  })

  //TC_342
  test("SELECT latest_year, latest_day, imei, gamepointid, deviceinformationid, series, imei, deliverycity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(gamepointid = 1600)")({
    checkAnswer(
      sql("SELECT latest_year, latest_day, imei, gamepointid, deviceinformationid, series, imei, deliverycity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(gamepointid = 1600)"),
  ...
  //TC_344
  test("SELECT gamePointId, deviceInformationId, Latest_YEAR, series, imei, deliveryCity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE deliveryCity LIKE 'wu%'")({
    checkAnswer(
      sql("SELECT gamePointId, deviceInformationId, Latest_YEAR, series, imei, deliveryCity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE deliveryCity LIKE 'wu%'"),
  ...
  //TC_345
  test("SELECT gamepointid, deviceinformationid, latest_year, series, imei, deliverycity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(imei LIKE '%1AA10%')")({
    checkAnswer(
      sql("SELECT gamepointid, deviceinformationid, latest_year, series, imei, deliverycity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(imei LIKE '%1AA10%')"),
      Seq(Row(2738.562, 1, 2015, "7Series", "1AA1", "yichang")))
  })

  //TC_346
  test("SELECT gamepointid, deviceinformationid, latest_year, series, imei, deliverycity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE gamepointid BETWEEN 1015 AND 1080")({
    checkAnswer(
      sql("SELECT gamepointid, deviceinformationid, latest_year, series, imei, deliverycity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE gamepointid BETWEEN 1015 AND 1080"),
  ...
  //TC_347
  test("SELECT gamepointid, deviceinformationid, latest_year, series, imei, deliverycity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE deviceinformationid = 100031")({
    checkAnswer(
      sql("SELECT gamepointid, deviceinformationid, latest_year, series, imei, deliverycity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE deviceinformationid = 100031"),
  ...
  //TC_349
  test("SELECT latest_year, gamepointid FROM (select * from Carbon_automation_test2) SUB_QRY WHERE gamepointid BETWEEN 200.0 AND 300.0")({
    checkAnswer(
      sql("SELECT latest_year, gamepointid FROM (select * from Carbon_automation_test2) SUB_QRY WHERE gamepointid BETWEEN 200.0 AND 300.0"),
      Seq(Row(2015, 298.0), Row(2015, 202.0), Row(2015, 256.0)))
  })

  //TC_351
  test("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE deliveryCity IN (\"changsha\")")({
    checkAnswer(
      sql("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE deliveryCity IN (\"changsha\")"),
  ...
  //TC_352
  test("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE deliveryCity IS NOT NULL")({
    checkAnswer(
      sql("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE deliveryCity IS NOT NULL"),
  ...
  //TC_353
  test("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(deliveryCity IN (\"guangzhou\",\"changsha\"))")({
    checkAnswer(
      sql("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(deliveryCity IN (\"guangzhou\",\"changsha\"))"),
  ...
  //TC_354
  test("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(imei BETWEEN \"1AA100\" AND \"1AA10000\")")({
    checkAnswer(
      sql("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(imei BETWEEN \"1AA100\" AND \"1AA10000\")"),
      Seq(Row(2738.562, 2015, 1, "1AA1", "yichang"), Row(1714.635, 2015, 10, "1AA10", "yichang"), Row(136.0, 2015, 100000, "1AA100000", "wuhan"), Row(1600.0, 2015, 1000000, "1AA1000000", "yichang"), Row(505.0, 2015, 100001, "1AA100001", "xiangtan"), Row(1341.0, 2015, 100002, "1AA100002", "changsha"), Row(2239.0, 2015, 100003, "1AA100003", "zhuzhou"), Row(2970.0, 2015, 100004, "1AA100004", "yichang"), Row(2593.0, 2015, 100005, "1AA100005", "yichang"), Row(2572.0, 2015, 100006, "1AA100006", "changsha"), Row(1991.0, 2015, 100007, "1AA100007", "changsha"), Row(1442.0, 2015, 100008, "1AA100008", "changsha"), Row(1841.0, 2015, 100009, "1AA100009", "yichang"), Row(298.0, 2015, 10001, "1AA10001", "changsha"), Row(79.0, 2015, 100010, "1AA100010", "zhuzhou"), Row(202.0, 2015, 100011, "1AA100011", "guangzhou"), Row(568.0, 2015, 100012, "1AA100012", "xiangtan"), Row(355.0, 2015, 100013, "1AA100013", "changsha"), Row(151.0, 2015, 100014, "1AA100014", "zhuzhou"), Row(2863.0, 2015, 100015, "1AA100015", "xiangtan"), Row(1873.0, 2015, 100016, "1AA100016", "changsha"), Row(2205.0, 2015, 100017, "1AA100017", "xiangtan"), Row(441.0, 2015, 100018, "1AA100018", "yichang"), Row(2194.0, 2015, 100019, "1AA100019", "zhuzhou"), Row(2972.0, 2015, 10002, "1AA10002", "wuhan"), Row(256.0, 2015, 100020, "1AA100020", "shenzhen"), Row(1778.0, 2015, 100021, "1AA100021", "changsha"), Row(1999.0, 2015, 100022, "1AA100022", "zhuzhou"), Row(2194.0, 2015, 100023, "1AA100023", "guangzhou"), Row(2483.0, 2015, 100024, "1AA100024", "changsha"), Row(1724.0, 2015, 100025, "1AA100025", "guangzhou"), Row(1768.0, 2015, 100026, "1AA100026", "yichang"), Row(2436.0, 2015, 100027, "1AA100027", "zhuzhou"), Row(2849.0, 2015, 100028, "1AA100028", "zhuzhou"), Row(1691.0, 2015, 100029, "1AA100029", "xiangtan"), Row(2071.0, 2015, 10003, "1AA10003", "xiangtan"), Row(1333.0, 2015, 100030, "1AA100030", "zhuzhou"), Row(1080.0, 2015, 100031, "1AA100031", "yichang"), Row(1053.0, 2015, 100032, "1AA100032", "shenzhen"), Row(760.0, 2015, 100033, "1AA100033", "wuhan"), Row(2061.0, 2015, 100034, "1AA100034", "guangzhou"), Row(2142.0, 2015, 100035, "1AA100035", "changsha"), Row(2224.0, 2015, 100036, "1AA100036", "changsha"), Row(1015.0, 2015, 100037, "1AA100037", "xiangtan"), Row(1229.0, 2015, 100038, "1AA100038", "shenzhen"), Row(1750.0, 2015, 100039, "1AA100039", "shenzhen"), Row(1717.0, 2015, 10004, "1AA10004", "guangzhou"), Row(2078.0, 2015, 100040, "1AA100040", "yichang"), Row(2734.0, 2015, 100041, "1AA100041", "shenzhen"), Row(2745.0, 2015, 100042, "1AA100042", "shenzhen"), Row(571.0, 2015, 100043, "1AA100043", "guangzhou"), Row(1697.0, 2015, 100044, "1AA100044", "guangzhou"), Row(2553.0, 2015, 100045, "1AA100045", "xiangtan"), Row(1077.0, 2015, 100046, "1AA100046", "guangzhou"), Row(1823.0, 2015, 100047, "1AA100047", "zhuzhou"), Row(2399.0, 2015, 100048, "1AA100048", "guangzhou"), Row(2890.0, 2015, 100049, "1AA100049", "guangzhou"), Row(1608.0, 2015, 10005, "1AA10005", "xiangtan"), Row(29.0, 2015, 100050, "1AA100050", "yichang"), Row(1407.0, 2015, 100051, "1AA100051", "guangzhou"), Row(845.0, 2015, 100052, "1AA100052", "zhuzhou"), Row(1655.0, 2015, 100053, "1AA100053", "wuhan"), Row(1368.0, 2015, 100054, "1AA100054", "shenzhen"), Row(1728.0, 2015, 100055, "1AA100055", "yichang"), Row(750.0, 2015, 100056, "1AA100056", "wuhan"), Row(2288.0, 2015, 100057, "1AA100057", "zhuzhou"), Row(2635.0, 2015, 100058, "1AA100058", "guangzhou"), Row(1337.0, 2015, 100059, "1AA100059", "shenzhen"), Row(2478.0, 2015, 10006, "1AA10006", "guangzhou"), Row(538.0, 2015, 100060, "1AA100060", "xiangtan"), Row(1407.0, 2015, 100061, "1AA100061", "changsha"), Row(2952.0, 2015, 100062, "1AA100062", "yichang"), Row(1226.0, 2015, 100063, "1AA100063", "yichang"), Row(865.0, 2015, 100064, "1AA100064", "zhuzhou"), Row(901.0, 2015, 100065, "1AA100065", "xiangtan"), Row(1864.0, 2015, 100066, "1AA100066", "zhuzhou"), Row(572.0, 2015, 100067, "1AA100067", "wuhan"), Row(412.0, 2015, 100068, "1AA100068", "guangzhou"), Row(1491.0, 2015, 100069, "1AA100069", "xiangtan"), Row(1350.0, 2015, 10007, "1AA10007", "xiangtan"), Row(1567.0, 2015, 100070, "1AA100070", "guangzhou"), Row(1973.0, 2015, 100071, "1AA100071", "guangzhou"), Row(448.0, 2015, 100072, "1AA100072", "changsha"), Row(2488.0, 2015, 100073, "1AA100073", "zhuzhou"), Row(907.0, 2015, 100074, "1AA100074", "wuhan"), Row(2507.0, 2015, 100075, "1AA100075", "shenzhen"), Row(732.0, 2015, 100076, "1AA100076", "wuhan"), Row(2077.0, 2015, 100077, "1AA100077", "yichang"), Row(1434.0, 2015, 100078, "1AA100078", "yichang"), Row(1098.0, 2015, 100079, "1AA100079", "xiangtan"), Row(813.0, 2015, 10008, "1AA10008", "shenzhen"), Row(954.0, 2015, 100080, "1AA100080", "shenzhen"), Row(613.0, 2015, 100081, "1AA100081", "shenzhen"), Row(2348.0, 2015, 100082, "1AA100082", "xiangtan"), Row(2192.0, 2015, 100083, "1AA100083", "zhuzhou"), Row(2826.0, 2015, 100084, "1AA100084", "guangzhou")))
  })

  //TC_355
  test("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity, series FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(series BETWEEN \"2Series\" AND \"5Series\")")({
    checkAnswer(
      sql("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity, series FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(series BETWEEN \"2Series\" AND \"5Series\")"),
  ...
  //TC_356
  test("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity, series FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(gamePointId >= 1000.0)")({
    checkAnswer(
      sql("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity, series FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(gamePointId >= 1000.0)"),
  ...
  //TC_357
  test("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity, series FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(gamePointId < 500.0)")({
    checkAnswer(
      sql("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity, series FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(gamePointId < 500.0)"),
  ...
  //TC_358
  test("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity, series FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(gamePointId <= 600.0)")({
    checkAnswer(
      sql("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity, series FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(gamePointId <= 600.0)"),
  ...
  //TC_359
  test("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity, series FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(deliveryCity LIKE '%wuhan%')")({
    checkAnswer(
      sql("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity, series FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(deliveryCity LIKE '%wuhan%')"),
  ...
  //TC_360
  test("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity, series FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(deliveryCity LIKE 'wu%')")({
    checkAnswer(
      sql("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity, series FROM (select * from Carbon_automation_test2) SUB_QRY WHERE NOT(deliveryCity LIKE 'wu%')"),
      Seq(Row(2738.562, 2015, 1, "1AA1", "yichang", "7Series"), Row(1714.635, 2015, 10, "1AA10", "yichang", "7Series"), Row(1271.0, 2015, 100, "1AA100", "xiangtan", "5Series"), Row(2175.0, 2015, 10000, "1AA10000", "guangzhou", "7Series"), Row(1600.0, 2015, 1000000, "1AA1000000", "yichang", "7Series"), Row(505.0, 2015, 100001, "1AA100001", "xiangtan", "0Series"), Row(1341.0, 2015, 100002, "1AA100002", "changsha", "0Series"), Row(2239.0, 2015, 100003, "1AA100003", "zhuzhou", "5Series"), Row(2970.0, 2015, 100004, "1AA100004", "yichang", "4Series"), Row(2593.0, 2015, 100005, "1AA100005", "yichang", "1Series"), Row(2572.0, 2015, 100006, "1AA100006", "changsha", "6Series"), Row(1991.0, 2015, 100007, "1AA100007", "changsha", "9Series"), Row(1442.0, 2015, 100008, "1AA100008", "changsha", "8Series"), Row(1841.0, 2015, 100009, "1AA100009", "yichang", "0Series"), Row(298.0, 2015, 10001, "1AA10001", "changsha", "2Series"), Row(79.0, 2015, 100010, "1AA100010", "zhuzhou", "3Series"), Row(202.0, 2015, 100011, "1AA100011", "guangzhou", "0Series"), Row(568.0, 2015, 100012, "1AA100012", "xiangtan", "4Series"), Row(355.0, 2015, 100013, "1AA100013", "changsha", "1Series"), Row(151.0, 2015, 100014, "1AA100014", "zhuzhou", "5Series"), Row(2863.0, 2015, 100015, "1AA100015", "xiangtan", "4Series"), Row(1873.0, 2015, 100016, "1AA100016", "changsha", "3Series"), Row(2205.0, 2015, 100017, "1AA100017", "xiangtan", "9Series"), Row(441.0, 2015, 100018, "1AA100018", "yichang", "8Series"), Row(2194.0, 2015, 100019, "1AA100019", "zhuzhou", "5Series"), Row(256.0, 2015, 100020, "1AA100020", "shenzhen", "5Series"), Row(1778.0, 2015, 100021, "1AA100021", "changsha", "0Series"), Row(1999.0, 2015, 100022, "1AA100022", "zhuzhou", "5Series"), Row(2194.0, 2015, 100023, "1AA100023", "guangzhou", "5Series"), Row(2483.0, 2015, 100024, "1AA100024", "changsha", "6Series"), Row(1724.0, 2015, 100025, "1AA100025", "guangzhou", "0Series"), Row(1768.0, 2015, 100026, "1AA100026", "yichang", "7Series"), Row(2436.0, 2015, 100027, "1AA100027", "zhuzhou", "0Series"), Row(2849.0, 2015, 100028, "1AA100028", "zhuzhou", "5Series"), Row(1691.0, 2015, 100029, "1AA100029", "xiangtan", "2Series"), Row(2071.0, 2015, 10003, "1AA10003", "xiangtan", "7Series"), Row(1333.0, 2015, 100030, "1AA100030", "zhuzhou", "7Series"), Row(1080.0, 2015, 100031, "1AA100031", "yichang", "7Series"), Row(1053.0, 2015, 100032, "1AA100032", "shenzhen", "1Series"), Row(2061.0, 2015, 100034, "1AA100034", "guangzhou", "2Series"), Row(2142.0, 2015, 100035, "1AA100035", "changsha", "5Series"), Row(2224.0, 2015, 100036, "1AA100036", "changsha", "5Series"), Row(1015.0, 2015, 100037, "1AA100037", "xiangtan", "7Series"), Row(1229.0, 2015, 100038, "1AA100038", "shenzhen", "6Series"), Row(1750.0, 2015, 100039, "1AA100039", "shenzhen", "8Series"), Row(1717.0, 2015, 10004, "1AA10004", "guangzhou", "5Series"), Row(2078.0, 2015, 100040, "1AA100040", "yichang", "8Series"), Row(2734.0, 2015, 100041, "1AA100041", "shenzhen", "5Series"), Row(2745.0, 2015, 100042, "1AA100042", "shenzhen", "3Series"), Row(571.0, 2015, 100043, "1AA100043", "guangzhou", "9Series"), Row(1697.0, 2015, 100044, "1AA100044", "guangzhou", "8Series"), Row(2553.0, 2015, 100045, "1AA100045", "xiangtan", "2Series"), Row(1077.0, 2015, 100046, "1AA100046", "guangzhou", "3Series"), Row(1823.0, 2015, 100047, "1AA100047", "zhuzhou", "9Series"), Row(2399.0, 2015, 100048, "1AA100048", "guangzhou", "3Series"), Row(2890.0, 2015, 100049, "1AA100049", "guangzhou", "0Series"), Row(1608.0, 2015, 10005, "1AA10005", "xiangtan", "8Series"), Row(29.0, 2015, 100050, "1AA100050", "yichang", "2Series"), Row(1407.0, 2015, 100051, "1AA100051", "guangzhou", "2Series"), Row(845.0, 2015, 100052, "1AA100052", "zhuzhou", "6Series"), Row(1368.0, 2015, 100054, "1AA100054", "shenzhen", "7Series"), Row(1728.0, 2015, 100055, "1AA100055", "yichang", "7Series"), Row(2288.0, 2015, 100057, "1AA100057", "zhuzhou", "9Series"), Row(2635.0, 2015, 100058, "1AA100058", "guangzhou", "5Series"), Row(1337.0, 2015, 100059, "1AA100059", "shenzhen", "4Series"), Row(2478.0, 2015, 10006, "1AA10006", "guangzhou", "3Series"), Row(538.0, 2015, 100060, "1AA100060", "xiangtan", "8Series"), Row(1407.0, 2015, 100061, "1AA100061", "changsha", "6Series"), Row(2952.0, 2015, 100062, "1AA100062", "yichang", "9Series"), Row(1226.0, 2015, 100063, "1AA100063", "yichang", "2Series"), Row(865.0, 2015, 100064, "1AA100064", "zhuzhou", "6Series"), Row(901.0, 2015, 100065, "1AA100065", "xiangtan", "0Series"), Row(1864.0, 2015, 100066, "1AA100066", "zhuzhou", "6Series"), Row(412.0, 2015, 100068, "1AA100068", "guangzhou", "8Series"), Row(1491.0, 2015, 100069, "1AA100069", "xiangtan", "8Series"), Row(1350.0, 2015, 10007, "1AA10007", "xiangtan", "8Series"), Row(1567.0, 2015, 100070, "1AA100070", "guangzhou", "0Series"), Row(1973.0, 2015, 100071, "1AA100071", "guangzhou", "0Series"), Row(448.0, 2015, 100072, "1AA100072", "changsha", "4Series"), Row(2488.0, 2015, 100073, "1AA100073", "zhuzhou", "4Series"), Row(2507.0, 2015, 100075, "1AA100075", "shenzhen", "3Series"), Row(2077.0, 2015, 100077, "1AA100077", "yichang", "3Series"), Row(1434.0, 2015, 100078, "1AA100078", "yichang", "2Series"), Row(1098.0, 2015, 100079, "1AA100079", "xiangtan", "4Series"), Row(813.0, 2015, 10008, "1AA10008", "shenzhen", "5Series"), Row(954.0, 2015, 100080, "1AA100080", "shenzhen", "9Series"), Row(613.0, 2015, 100081, "1AA100081", "shenzhen", "5Series"), Row(2348.0, 2015, 100082, "1AA100082", "xiangtan", "5Series"), Row(2192.0, 2015, 100083, "1AA100083", "zhuzhou", "0Series"), Row(2826.0, 2015, 100084, "1AA100084", "guangzhou", "0Series")))
  })

  //TC_361
  test("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity, series FROM (select * from Carbon_automation_test2) SUB_QRY WHERE deliveryCity IN (\"changsha\")")({
    checkAnswer(
      sql("SELECT gamePointId, Latest_YEAR, deviceInformationId, imei, deliveryCity, series FROM (select * from Carbon_automation_test2) SUB_QRY WHERE deliveryCity IN (\"changsha\")"),
  ...
  //TC_362
  test("SELECT Latest_YEAR, deviceInformationId, imei, deliveryCity, series, gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY")({
    checkAnswer(
      sql("SELECT Latest_YEAR, deviceInformationId, imei, deliveryCity, series, gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY"),
  ...
  //TC_363
  test("SELECT Latest_YEAR, deviceInformationId, imei, deliveryCity, series, gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY ORDER BY deviceInformationId ASC")({
    checkAnswer(
      sql("SELECT Latest_YEAR, deviceInformationId, imei, deliveryCity, series, gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY ORDER BY deviceInformationId ASC"),
  ...
  //TC_364
  test("SELECT Latest_YEAR, deviceInformationId, imei, deliveryCity, series, gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY ORDER BY deviceInformationId DESC")({
    checkAnswer(
      sql("SELECT Latest_YEAR, deviceInformationId, imei, deliveryCity, series, gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY ORDER BY deviceInformationId DESC"),
  ...
  //TC_369
  test("SELECT series, gamePointId, deviceInformationId, Latest_YEAR, imei, deliveryCity FROM (select * from Carbon_automation_test2) SUB_QRY ORDER BY imei ASC, deliveryCity ASC, series ASC")({
    checkAnswer(
      sql("SELECT series, gamePointId, deviceInformationId, Latest_YEAR, imei, deliveryCity FROM (select * from Carbon_automation_test2) SUB_QRY ORDER BY imei ASC, deliveryCity ASC, series ASC"),
  ...
  //TC_372
  test("SELECT Latest_YEAR, deviceInformationId, imei, deliveryCity, series, gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY ORDER BY gamePointId ASC")({
    checkAnswer(
      sql("SELECT Latest_YEAR, deviceInformationId, imei, deliveryCity, series, gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY ORDER BY gamePointId ASC"),
  ...
  //TC_373
  test("SELECT Latest_YEAR, deviceInformationId, imei, deliveryCity, series, gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY ORDER BY gamePointId DESC")({
    checkAnswer(
      sql("SELECT Latest_YEAR, deviceInformationId, imei, deliveryCity, series, gamePointId FROM (select * from Carbon_automation_test2) SUB_QRY ORDER BY gamePointId DESC"),
  ...
  //TC_390
  test("select Latest_DAY,imei,gamepointid  from Carbon_automation_test2 where ( Latest_DAY+1) == 2 order by imei limit 5")({
    checkAnswer(
      sql("select Latest_DAY,imei,gamepointid  from Carbon_automation_test2 where ( Latest_DAY+1) == 2 order by imei limit 5"),
      Seq(Row(1, "1AA1", 2738.562), Row(1, "1AA10", 1714.635), Row(1, "1AA100", 1271.0), Row(1, "1AA1000", 692.0), Row(1, "1AA10000", 2175.0)))
  })

  //TC_391
  test("select gamepointid,imei from Carbon_automation_test2 where ( gamePointId+1) == 80 order by imei limit 5")({
    checkAnswer(
      sql("select gamepointid,imei from Carbon_automation_test2 where ( gamePointId+1) == 80 order by imei limit 5"),
      Seq(Row(79.0, "1AA100010")))
  })

  //TC_392
  test("select deviceInformationId,imei from Carbon_automation_test2 where ( deviceInformationId+1) == 100084 order by imei limit 5")({
    checkAnswer(
      sql("select deviceInformationId,imei from Carbon_automation_test2 where ( deviceInformationId+1) == 100084 order by imei limit 5"),
      Seq(Row(100083, "1AA100083")))
  })

  //TC_393
  test("select channelsId,imei from Carbon_automation_test2 where ( channelsId+1) == 5 order by imei limit 5")({
    checkAnswer(
      sql("select channelsId,imei from Carbon_automation_test2 where ( channelsId+1) == 5 order by imei limit 5"),
      Seq(Row("4", "1AA1"), Row("4", "1AA10"), Row("4", "1AA100018"), Row("4", "1AA100027"), Row("4", "1AA10003")))
  })

  //TC_394
  test("select contractNumber,imei from Carbon_automation_test2 where (contractNumber+1) == 507230.0 order by imei limit 5")({
    checkAnswer(
      sql("select contractNumber,imei from Carbon_automation_test2 where (contractNumber+1) == 507230.0 order by imei limit 5"),
      Seq(Row(507229.0, "1AA100083")))
  })

  //TC_395
  test("select  Latest_YEAR,imei from Carbon_automation_test2 where ( Latest_YEAR+1) == 2016 order by imei limit 5")({
    checkAnswer(
      sql("select  Latest_YEAR,imei from Carbon_automation_test2 where ( Latest_YEAR+1) == 2016 order by imei limit 5"),
      Seq(Row(2015, "1AA1"), Row(2015, "1AA10"), Row(2015, "1AA100"), Row(2015, "1AA1000"), Row(2015, "1AA10000")))
  })

  //TC_396
  test("select Latest_province,imei from Carbon_automation_test2 where UPPER(Latest_province) == 'GUANGDONG PROVINCE' order by imei limit 5")({
    checkAnswer(
      sql("select Latest_province,imei from Carbon_automation_test2 where UPPER(Latest_province) == 'GUANGDONG PROVINCE' order by imei limit 5"),
  ...
  //TC_397
  test("select Latest_DAY,imei from Carbon_automation_test2 where UPPER(Latest_DAY) == '1' order by imei limit 5")({
    checkAnswer(
      sql("select Latest_DAY,imei from Carbon_automation_test2 where UPPER(Latest_DAY) == '1' order by imei limit 5"),
      Seq(Row(1, "1AA1"), Row(1, "1AA10"), Row(1, "1AA100"), Row(1, "1AA1000"), Row(1, "1AA10000")))
  })

  //TC_398
  test("select Latest_DAY,imei from Carbon_automation_test2 where LOWER(Latest_DAY) == '1' order by imei limit 5")({
    checkAnswer(
      sql("select Latest_DAY,imei from Carbon_automation_test2 where LOWER(Latest_DAY) == '1' order by imei limit 5"),
      Seq(Row(1, "1AA1"), Row(1, "1AA10"), Row(1, "1AA100"), Row(1, "1AA1000"), Row(1, "1AA10000")))
  })

  //TC_399
  test("select deviceInformationId,imei from Carbon_automation_test2 where UPPER(deviceInformationId) == '1' order by imei limit 5")({
    checkAnswer(
      sql("select deviceInformationId,imei from Carbon_automation_test2 where UPPER(deviceInformationId) == '1' order by imei limit 5"),
      Seq(Row(1, "1AA1")))
  })

  //TC_400
  test("select deviceInformationId,imei from Carbon_automation_test2 where LOWER(deviceInformationId) == '1' order by imei limit 5")({
    checkAnswer(
      sql("select deviceInformationId,imei from Carbon_automation_test2 where LOWER(deviceInformationId) == '1' order by imei limit 5"),
      Seq(Row(1, "1AA1")))
  })


  //TC_401
  test("select channelsId,imei from Carbon_automation_test2 where UPPER(channelsId) == '4' order by imei limit 5")({
    checkAnswer(
      sql("select channelsId,imei from Carbon_automation_test2 where UPPER(channelsId) == '4' order by imei limit 5"),
      Seq(Row("4", "1AA1"), Row("4", "1AA10"), Row("4", "1AA100018"), Row("4", "1AA100027"), Row("4", "1AA10003")))
  })

  //TC_402
  test("select channelsId,imei from Carbon_automation_test2 where LOWER(channelsId) == '4' order by imei limit 5")({
    checkAnswer(
      sql("select channelsId,imei from Carbon_automation_test2 where LOWER(channelsId) == '4' order by imei limit 5"),
      Seq(Row("4", "1AA1"), Row("4", "1AA10"), Row("4", "1AA100018"), Row("4", "1AA100027"), Row("4", "1AA10003")))
  })

  //TC_403
  test("select gamePointId,imei from Carbon_automation_test2 where UPPER(gamePointId) == '136.0' order by imei limit 5")({
    checkAnswer(
      sql("select gamePointId,imei from Carbon_automation_test2 where UPPER(gamePointId) == '136.0' order by imei limit 5"),
      Seq(Row(136.0, "1AA100000")))
  })

  //TC_404
  test("select gamePointId,imei from Carbon_automation_test2 where LOWER(gamePointId) == '136.0' order by imei limit 5")({
    checkAnswer(
      sql("select gamePointId,imei from Carbon_automation_test2 where LOWER(gamePointId) == '136.0' order by imei limit 5"),
      Seq(Row(136.0, "1AA100000")))
  })

  //TC_405
  test("select imei from Carbon_automation_test2 where UPPER(imei) == '1AA100083' order by imei limit 5")({
    checkAnswer(
      sql("select imei from Carbon_automation_test2 where UPPER(imei) == '1AA100083' order by imei limit 5"),
      Seq(Row("1AA100083")))
  })

  //TC_406
  test("select imei from Carbon_automation_test2 where LOWER(imei) == '1aa100083' order by imei limit 5")({
    checkAnswer(
      sql("select imei from Carbon_automation_test2 where LOWER(imei) == '1aa100083' order by imei limit 5"),
      Seq(Row("1AA100083")))
  })
  ...
  test("select MAC,imei from Carbon_automation_test2 where UPPER(MAC)='MAC' order by imei limit 10")({
    checkAnswer(
      sql("select MAC,imei from Carbon_automation_test2 where UPPER(MAC)='MAC' order by imei limit 10"),
  ...
  //TC_442
  test("select variance(deviceInformationId), var_pop(imei)  from Carbon_automation_test2 where activeareaid>3")({
    checkAnswer(
      sql("select variance(deviceInformationId), var_pop(imei)  from Carbon_automation_test2 where activeareaid>3"),
      Seq(Row(1.477644655616972E10, null)))
  })

  //TC_443
  test("select variance(contractNumber), var_pop(contractNumber)  from Carbon_automation_test2 where deliveryareaid>5")({
    checkAnswer(
      sql("select variance(contractNumber), var_pop(contractNumber)  from Carbon_automation_test2 where deliveryareaid>5"),
      Seq(Row(8.508651970169495E12, 8.508651970169495E12)))
  })

  //TC_444
  test("select variance(AMSize), var_pop(channelsid)  from Carbon_automation_test2 where channelsid>2")({
    checkAnswer(
      sql("select variance(AMSize), var_pop(channelsid)  from Carbon_automation_test2 where channelsid>2"),
      Seq(Row(null, 2.148423005565863)))
  })

  //TC_446
  test("select variance(deviceInformationId), var_pop(deviceInformationId)  from Carbon_automation_test2 where activeareaid>3")({
    checkAnswer(
      sql("select variance(deviceInformationId), var_pop(deviceInformationId)  from Carbon_automation_test2 where activeareaid>3"),
